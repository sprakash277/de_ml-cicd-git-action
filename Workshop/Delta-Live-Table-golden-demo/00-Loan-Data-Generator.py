...
dbutils.widgets.text('userid', '', 'Format - sumit.prakash@databricks.com')
...
output_path = "/dlt_demo/" + userid + "/dlt_loan"
...
"""{
  ...
  "properties": {
    ...
    "country_code": {
      ...
      "$ref": "/FileStore/sumit_live_tbl_schema/country_code"
    },
    "cost_center_code": {
    ...
    "currency_code": {
      ...
      "$ref": "/FileStore/sumit_live_tbl_schema/currency_code"
    },
    "customer_id": {
    ...
    "impairment_status": {
      "$ref": "/FileStore/sumit_live_tbl_schema/impairment_status"
    },
    "insolvency_rank": {
    ...
    "regulatory_book": {
      "$ref": "/FileStore/sumit_live_tbl_schema/regulatory_book"
    },
